      ...
      <div className="col-span-3 bg-gray-400  rounded shadow-md m-4">
        ...
        <div className="col-span-3 bg-gray-400  rounded shadow-md m-4">
          <div style={{ backgroundColor: "#dfe2e8" }}>
            <BrushChart data={data.main_valve_history.map(({datetime, y}) => ({x: new Date(datetime), y}))}/>
          </div>
        </div>
      </div>
    </div>
